...
# Wrapper functions to interact with the products data
...
# Add a new product to the list and save it to the JSON file
...
# Remove a product by its ID and save the updated list to the JSON file
...
# Update a product by its ID with the provided update data and save the changes to the JSON file
